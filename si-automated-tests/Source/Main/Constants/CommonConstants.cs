...
namespace si_automated_tests.Source.Main.Constants
{
    public class CommonConstants
    {
        ...
        public static readonly string[] ActionUpdateInHistoryTaskLineDetail = { "ActualAssetQuantity", "Asset Type", "ActualProductQuantity", "ScheduledAssetQuantity", "ScheduledProductQuantity", "State", "Order", "Completed Date", "ClientReference", "Site", "Site Product", "Minimum Asset Quantity", "Maximum Asset Quantity", "Minimum Product Quantity", "Maximum Product Quantity", "Auto Confirmed" };
