...
{
    public class DetailContractSitePage : BasePage
    {
        ...
        [AllureStep]
        public DetailContractSitePage WaitForDetailContractSiteDisplayed()
        {
        ...
        [AllureStep]
        public DetailContractSitePage ClickOnNotesTab()
        {
        ...
        [AllureStep]
        public DetailContractSitePage IsNotesTab()
        {
