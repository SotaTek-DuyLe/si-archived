...
namespace si_automated_tests.Source.Main.Pages.Applications
{
    public class TaskAllocationPage : BasePageCommonActions
    {
        ...
        public readonly By LockFilterInput = By.XPath("//div[contains(@id, 'round-tab')]//div[contains(@class, 'l30')]//input");
        ...
        {
            ScrollRightOffset(By.XPath("//div[contains(@id, 'round-tab-r')]//div[@class='slick-viewport']"));
