...
namespace si_automated_tests.Source.Main.Pages.Applications
{
    public class TaskAllocationPage : BasePageCommonActions
    {
        ...
        private readonly string assuredChecked = "//div[contains(@id, 'round-tab-r')]//div[contains(string(), '{0}')]/following-sibling::div[contains(@class, 'l25')]/div[text()='✓']";
        private readonly string assuredNotChecked = "//div[contains(@id, 'round-tab-r')]//div[contains(string(), '{0}')]/following-sibling::div[contains(@class, 'l25')]/div[text()='✗']";
