...
namespace si_automated_tests.Source.Test.TaskTests
{
    ...
    public class BulkUpdateTaskTests : BaseTest
    {
        ...
        public void TC_126_step_4_1_selecting_date_time_in_top_panel_no_values_in_bottom_panel()
        {
            ...
            string firstTaskId = "8853";
            string secondTaskId = "8857";
            string firstTaskTypeName = "Collect Domestic Refuse";
            string secondTaskTypeName = "Collect Domestic Recycling";
            //DB - Get task
            TaskDBModel firstTaskBefore = finder.GetTask(int.Parse(firstTaskId))[0];
            TaskDBModel secondTaskBefore = finder.GetTask(int.Parse(secondTaskId))[0];
            ...
            string completionDateFirstTask = timeNow;
            if (DateTime.Compare(firstTaskBefore.taskduedate, dateTime) < 0)
            {
                completionDateFirstTask = firstTaskBefore.taskduedate.ToString(CommonConstants.DATE_DD_MM_YYYY_HH_MM_FORMAT);
            }

            string completionDateSecondTask = timeNow;
            if (DateTime.Compare(secondTaskBefore.taskduedate, dateTime) < 0)
            {
                completionDateSecondTask = secondTaskBefore.taskduedate.ToString(CommonConstants.DATE_DD_MM_YYYY_HH_MM_FORMAT);
            }

            tasksBulkUpdatePage
                .VerifyTaskAfterBulkUpdating(taskDBModelFirstTask, note, completionDateFirstTask, timeNow)
                .VerifyTaskAfterBulkUpdating(taskDBModelSecondTask, note, completionDateSecondTask, timeNow);
            ...
            detailTaskPage
                .IsDetailTaskPage()
                .ClickOnDetailTab()
                .VerifyFieldAfterBulkUpdate(note, timeNow, "Completed", completionDateFirstTask, "")
                .ClickCloseBtn()
                .SwitchToChildWindow(1)
                .SwitchNewIFrame();
            PageFactoryManager.Get<TasksListingPage>()
            ...
            detailTaskPage
                .IsDetailTaskPage()
                .ClickOnDetailTab()
                .VerifyFieldAfterBulkUpdate(note, timeNow, "Completed", completionDateSecondTask, "");
        }
        ...
        {
            CommonFinder finder = new CommonFinder(DbContext);
            string firstTaskId = "9107";
            string secondTaskId = "9115";
            string secondTaskTypeName = "Collect Domestic Recycling";
            string firstTaskTypeName = "Collect Domestic Refuse";
            //DB - Get task
            ...
            string[] valueExpInServiceUpdateSecondTask = { "0", "0", "Not Completed", completedDateDDMMYYYY, "Manually Confirmed on Web"};
            ...
            detailTaskPage
                ...
                .VerifyHistoryTabFirstAfterBulkUpdating(AutoUser55.DisplayName, completedDateDisplayed, CommonConstants.ServiceUpdateColumnNotCompletedHistoryTab, valueExpInServiceUpdateSecondTask)
                .VerifyTitleTaskLineSecondServiceUpdate()
                .VerifyHistoryTabSecondAfterBulkUpdating(AutoUser55.DisplayName, completedDateDisplayed, CommonConstants.ServiceUpdateColumnNotCompletedHistoryTab, valueExpInServiceUpdateSecondTask)
                .VerifyTitleUpdate()
            ...
            detailTaskPage
                ...
                .VerifyFirstTaskLineStateVerdictTab(completedDateDisplayed, "Not Completed", "Manually Confirmed on Web", "Plastic")
                .VerifySecondTaskLineStateVerdictTab(completedDateDisplayed, "Not Completed", "Manually Confirmed on Web", "Paper & Cardboard");
            //Step 4: Line 53 - Task line tab
            detailTaskPage
                .ClickOnTaskLineTab()
                .VerifyFirstTaskLineAfterBulkUpdate("Plastic", "Not Completed", "")
                .VerifySecondTaskLineAfterBulkUpdate("Paper & Cardboard", "Not Completed", "")
                .ClickCloseBtn()
                .SwitchToChildWindow(1)
                .SwitchNewIFrame();
            ...
            detailTaskPage
                ...
                .ClickOnTaskLineVerdictTab()
                .VerifyFirstTaskLineStateVerdictTab(completedDateDisplayed, "Completed", "Manually Confirmed on Web", "General Refuse");
            //Step 4: Line 53 - Task line tab
            detailTaskPage
                .ClickOnTaskLineTab()
                .VerifyFirstTaskLineAfterBulkUpdate("General Refuse", "Completed", "");
        ...
        {
            CommonFinder finder = new CommonFinder(DbContext);
            string firstTaskId = "9111";
            string secondTaskId = "9108";
            string firstTaskTypeName = "Collect Domestic Recycling";
            string secondTaskTypeName = "Collect Domestic Refuse";
            //DB - Get task
            TaskDBModel firstTaskDB = finder.GetTask(int.Parse(firstTaskId))[0];
            TaskDBModel secondTaskDB = finder.GetTask(int.Parse(firstTaskId))[0];
            ...
            PageFactoryManager.Get<TasksListingPage>()
                ...
                .WaitForLoadingIconToDisappear();
            DetailTaskPage detailTaskPage = PageFactoryManager.Get<DetailTaskPage>();
            string completionDateSecondTask = detailTaskPage.CompareDueDateWithTimeNow(secondTaskDB, completedDateEndDateSecondTask);
            string[] valueExpInServiceUpdateSecondTask = { "1", "1", "Completed", "", completedDateDDMMYYYY, "Manually Confirmed on Web" };
            string[] valueExpUpdateSecondTask = { topNote + " " + noteSecondTask, completionDateSecondTask, "Completed", completedDateEndDateSecondTask};
            ...
            detailTaskPage
                ...
                .ClickOnVerdictTab()
                .ClickOnTaskInformation()
                .VerifyTaskInformationAfterBulkUpdating(completionDateSecondTask, "Completed", "", "Manually Confirmed on Web")
                .ClickOnTaskLineVerdictTab()
                .VerifyFirstTaskLineStateVerdictTab(completedDateDisplayed, "Completed", "Manually Confirmed on Web", "General Refuse")
            ...
            detailTaskPage
                ...
                .VerifyTitleUpdate()
                .VerifyHistoryTabUpdate(AutoUser55.DisplayName, completedDateDisplayed, CommonConstants.UpdateColumnHistoryTabFirst, valueExpUpdateFirstTask);
            //Step 4: Line 53 - Verdict tab
            detailTaskPage
                .ClickOnVerdictTab()
                .ClickOnTaskInformation()
