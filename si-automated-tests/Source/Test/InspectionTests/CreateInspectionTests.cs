    ...
    public class CreateInspectionTests : BaseTest
    {
        ...
        public void TC_079_Create_inspection_from_task()
        {
            ...
            PageFactoryManager.Get<AllInspectionListingPage>()
                .VerifyTheFirstInspection(allInspectionModels[0], inspectionModels[0], location, Contract.NS, location, serviceName);
        }
        ...
        public void TC_080_Create_inspection_from_event()
        {
            ...
            List<InspectionModel> inspectionModels = PageFactoryManager.Get<AllInspectionListingPage>()
                .getAllInspectionInList(1);
            PageFactoryManager.Get<AllInspectionListingPage>()
                .VerifyTheFirstInspection(pointHistoryModels[0], inspectionModels[0], locationValueWithoutIcon, Contract.NS, locationValueWithoutIcon, "Clinical Waste", AutoUser14.UserName, assignedUserValue, allocatedUnitValue);
        }
        ...
        public void TC_083_Create_inspection_from_point_address()
        {
            ...
            PageFactoryManager.Get<AllInspectionListingPage>()
                .VerifyTheFirstInspection(inspectionModels[0], locationValue, Contract.NS, locationValue, "", AutoUser14.UserName, assignedUserValue, allocatedUnitValue, inspectionId.ToString(), inspectionTypeValue, "Pending", CommonUtil.GetLocalTimeNow(CommonConstants.DATE_DD_MM_YYYY_FORMAT), CommonUtil.GetLocalTimeMinusDay(CommonConstants.DATE_DD_MM_YYYY_FORMAT, 1))
                .DoubleClickFirstInspectionRow()
                .SwitchToLastWindow();
        ...
        public void TC_088_Create_inspection_from_point_node()
        {
            ...
            List<InspectionModel> inspectionModels = PageFactoryManager.Get<AllInspectionListingPage>()
                .getAllInspectionInList(1);
            PageFactoryManager.Get<AllInspectionListingPage>()
                .VerifyTheFirstInspection(inspectionModels[0], locationValue, Contract.NS, locationValue, "", AutoUser45.UserName, assignedUserValue, allocatedUnitValue, inspectionId.ToString(), inspectionTypeValue, "Pending", CommonUtil.GetLocalTimeNow(CommonConstants.DATE_DD_MM_YYYY_FORMAT), CommonUtil.GetLocalTimeMinusDay(CommonConstants.DATE_DD_MM_YYYY_FORMAT, 1))
                .DoubleClickFirstInspectionRow()
                .SwitchToLastWindow();
