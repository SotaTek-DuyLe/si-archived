...
namespace si_automated_tests.Source.Test.InspectionTests
{
    public class UpdateInspectionTests : BaseTest
    {
        ...
        [Category("UpdateInspection")]
        [Test(Description = "Inspection Update and states - Cancel - InspectionType = 4")]
        ...
        [Category("UpdateInspection")]
        [Test(Description = "Inspection Update and states - Expire - InspectionType = 4")]
        ...
        [Category("UpdateInspection")]
        [Test(Description = "Inspection Update and states - Complete - 1")]
        ...
        [Category("UpdateInspection")]
        [Test(Description = "Inspection Update and states - Complete - 2")]
